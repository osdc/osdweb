      ...
      <div className={styles.content}>
        <div className={styles.locations}>
          ...
          <ul>
            ...
            <li><button className={`system-button ${styles['navigation-btn']} ${mobileClass}`} onClick={() => { onClickLocation('/Users/osdc/'); }}>Home</button></li>
            <li><button className={`system-button ${styles['navigation-btn']} ${mobileClass}`} onClick={() => { onClickLocation('/Users/osdc/Desktop/'); }}>Desktop</button></li>
            <li><button className={`system-button ${styles['navigation-btn']} ${mobileClass}`} onClick={() => { onClickLocation('/Users/osdc/Documents'); }}>Documents</button></li>
          </ul>
        </div>
